        ...
        <section id='projects' className="flex flex-col py-5 px-5 justify-center bg-primary text-white">
            ...
            <div className="w-full">
                <div className='flex flex-col md:flex-row px-10 gap-5'>
                    ...
                    <div className='relative'>
                        <img className='h-[200px] w-[500px]' src={Stop} alt="Stopwatch Website Screenshot" />
                    ...
                    <div className='relative'>
                        <img className='h-[200px] w-[500px]' src={blog} alt="Blog Website Screenshot" />
                        <div className='project-desc'>
                            <p className='text-center py-5'>Basic Blog Website. Built with React JS.</p>
                            <a className='btn' href='https://yourblogsite.com'>View Project</a>
                        </div>
                    </div>
                </div>
            </div>
